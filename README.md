...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/603c94135c73fe0015d1145b
...
To start editing your site, you can use the Sanity interface at https://magical-europa-c9413.sanity.studio/.
...
Generated at `2021-03-01T07:13:52.255Z` by Stackbit version `0.3.50`.